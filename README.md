...
## V20.8.24 FINAL
- Base: falta bd.zip.
- Salvamento reforçado no app_state sem apagar importações.
- Botão Editar Campos e Cancelar nas telas de edição.
- Campos novos liberados por padrão.
- Autocomplete/combo acima de 2 caracteres mantido/reforçado.
- Correção de formulário prestador com erro de anexos.
- O.S.: filtro por status, mostrar todas, editar/remover junção, cancelar/excluir e liberar chamados removidos.
- schema.sql seguro.

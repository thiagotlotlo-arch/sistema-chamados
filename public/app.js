...
/* PATCH V20.8.19 AUTO UPPERCASE + MOBILE */
(function(){
  ...
  document.addEventListener('DOMContentLoaded',()=>{
    ...
    document.querySelectorAll('.version,.badge-version').forEach(e=>e.textContent = "V20.8.19");
  });
  setInterval(()=>document.querySelectorAll('.version,.badge-version').forEach(e=>e.textContent = "V20.8.19"),1000);
})();

/* PATCH V20.8.19 FRONT FIX */
(function(){
  function setVersion(){
    document.querySelectorAll(".version,.badge-version").forEach(e=>e.textContent="V20.8.19");
  }
...
/* PATCH V20.8.19 - COMPARTILHAR PDF DA O.S. */

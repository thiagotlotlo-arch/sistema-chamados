...
/* PATCH V20.8.21 AUTO UPPERCASE + MOBILE */
(function(){
  ...
  document.addEventListener('DOMContentLoaded',()=>{
    ...
    document.querySelectorAll('.version,.badge-version').forEach(e=>e.textContent = "V20.8.21");
  });
  setInterval(()=>document.querySelectorAll('.version,.badge-version').forEach(e=>e.textContent = "V20.8.21"),1000);
})();

/* PATCH V20.8.21 FRONT FIX */
(function(){
  function setVersion(){
    document.querySelectorAll(".version,.badge-version").forEach(e=>e.textContent="V20.8.21");
  }
...
/* PATCH V20.8.21 - COMPARTILHAR PDF DA O.S. */

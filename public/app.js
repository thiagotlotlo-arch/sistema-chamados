...
/* PATCH V20.8.11 AUTO UPPERCASE + MOBILE */
(function(){
  ...
  setInterval(()=>document.querySelectorAll('.version,.badge-version').forEach(e=>e.textContent = "V20.8.11"),1000);
})();

/* PATCH V20.8.11 FRONT FIX */
(function(){
  function setVersion(){
    document.querySelectorAll(".version,.badge-version").forEach(e=>e.textContent="V20.8.11");
  }

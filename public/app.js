...
/* PATCH V20.8.24 FRONT - CIDADES/UF COMBO + ROTAS PDF */
(function(){
 ...
 document.addEventListener("DOMContentLoaded",()=>{
   document.querySelectorAll(".version").forEach(v=>v.textContent="V20.8.24");
...
/* PATCH V20.8.24 FRONT - usar rota v152 loja */
(function(){
...
/* PATCH V20.8.24 FRONT - PDF usa rotas v153 */
(function(){
...
/* PATCH V20.8.24 FRONT - Config filial e PDF loja */
(function(){
...
document.addEventListener("DOMContentLoaded",()=>{document.querySelectorAll(".version").forEach(v=>v.textContent="V20.8.24");if(location.pathname==="/importar-planilha"){document.querySelectorAll('form').forEach(f=>{if(f.querySelector('input[type="file"]')){f.action="/v155/importar-planilha";f.method="post";f.enctype="multipart/form-data"}})}document.querySelectorAll('input[name="analista"],input[name="analistaResponsavel"],input[name="analista_responsavel"],input[placeholder*="ANALISTA" i]').forEach(i=>{i.autocomplete="off";i.addEventListener("input",()=>{clearTimeout(i._t);i._t=setTimeout(()=>sug(i),160)})})});
...
document.addEventListener("DOMContentLoaded",()=>{document.querySelectorAll(".version").forEach(v=>v.textContent="V20.8.24");const path=location.pathname;if(path.includes("/lojas/")||path==="/lojas/nova"){document.querySelectorAll('form[enctype="multipart/form-data"]').forEach(f=>{if(f.querySelector('input[name="pdf"]')){const id=(path.match(/\/lojas\/(\d+)\/editar/)||[])[1]||"";f.action=id?"/v159/loja-pdf/"+id:"/v159/loja-pdf";f.method="post";}})}document.querySelectorAll('button,a,input[type="button"],input[type="submit"]').forEach(b=>{const txt=(b.innerText||b.value||"").toUpperCase();if(txt.includes("GERAR LOCALIZAÇÃO")||txt.includes("GERAR LOCALIZACAO")){if(b.tagName==="A")b.href="javascript:void(0)";if(b.type)b.type="button";b.onclick=function(e){e.preventDefault();abrirMaps();return false;};}})});
})();
...
/* PATCH V20.8.24 FRONT */
(function(){if(window.__V161__)return;window.__V161__=true;document.addEventListener("DOMContentLoaded",()=>{document.querySelectorAll(".version").forEach(v=>v.textContent="V20.8.24");document.querySelectorAll('a,button').forEach(el=>{const txt=(el.textContent||"").toUpperCase();if(txt==="CHAMADOS"||txt.includes("📋 CHAMADOS")){if(el.tagName==="A")el.href="/chamados?mostrar=abertos";}});});})();


/* PATCH V20.8.24 AUTO UPPERCASE + MOBILE */
(function(){
  ...
  document.addEventListener('DOMContentLoaded',()=>{
    ...
    document.querySelectorAll('.version,.badge-version').forEach(e=>e.textContent = "V20.8.24");
  });
  setInterval(()=>document.querySelectorAll('.version,.badge-version').forEach(e=>e.textContent = "V20.8.24"),1000);
})();

/* PATCH V20.8.24 FRONT FIX */
(function(){
  function setVersion(){
    document.querySelectorAll(".version,.badge-version").forEach(e=>e.textContent="V20.8.24");
  }
...
/* PATCH V20.8.24 - COMPARTILHAR PDF DA O.S. */

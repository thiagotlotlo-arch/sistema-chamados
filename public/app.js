...
/* PATCH V20.8.18 AUTO UPPERCASE + MOBILE */
(function(){
  ...
  document.addEventListener('DOMContentLoaded',()=>{
    ...
    document.querySelectorAll('.version,.badge-version').forEach(e=>e.textContent = "V20.8.18");
  });
  setInterval(()=>document.querySelectorAll('.version,.badge-version').forEach(e=>e.textContent = "V20.8.18"),1000);
})();

/* PATCH V20.8.18 FRONT FIX */
(function(){
  function setVersion(){
    document.querySelectorAll(".version,.badge-version").forEach(e=>e.textContent="V20.8.18");
  }
...
/* PATCH V20.8.18 - COMPARTILHAR PDF DA O.S. */
